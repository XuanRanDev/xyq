        ...
        <div class="right-container">
            ...
            <div style="margin:0 auto;width: 200px;height: 800px;">
                <h1 style="text-align: center;">找回密码</h1>
                    ...
                    <div class="form-group" style="margin-top:20px;">
                        <label >新　密　码：</label>
                        <input type="password" class="form-control" name="password1" placeholder="密码" id="psw1" style="width: 200px;" required>
                    </div>
                    <div class="form-group" style="margin-top:20px;">
                        <label >确认密码：</label>
                        <input type="password" class="form-control" name="password2" placeholder="密码" id="psw2" style="width: 200px;" required>
                    </div>
