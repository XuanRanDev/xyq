            ...
            <form method="post" action="<c:url value="/pwdEdit"/>" name="form2" onsubmit="return updatepsw()">
                <div style="margin:0 auto;width: 200px;height: 800px;">
                        ...
                        <div class="form-group" style="margin-top:20px;">
                            <label>原　密　码：</label>
                            <input type="password" class="form-control" name="psw" placeholder="旧密码" style="width: 200px" required autofocus>
                        </div>
                        <div class="form-group" style="margin-top:20px;">
                            <label>新　密　码：</label>
                            <input type="password" class="form-control" name="psw1" id="psw1" placeholder="新密码" style="width: 200px;" required>
                        </div>
                        <div class="form-group" style="margin-top:20px;">
                            <label >确认密码：</label>
                            <input type="password" class="form-control" name="psw2" id="psw2" placeholder="新密码" style="width: 200px;" required>
                        </div>
