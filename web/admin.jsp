        ...
        <div class="menu-body">
            <div class="panel-group" id="accordion">
                <div class="panel panel-default">
                        ...
                        <h4 class="panel-title">
                            ...
                            <div id="collapseOne" class="panel-collapse collapse in">
                                <div class="panel-body aaa" style="text-align: center;">
                                    <a  class="aaa" target="frame" href="<c:url value="/adminUser"/>">用户信息</a>
                                </div>
                                <div class="panel-body aaa" style="text-align: center">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">菜品管理</a></h4>
                                </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseThree">订单管理</a></h4>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseFour">评论管理</a></h4>
                        </div>
