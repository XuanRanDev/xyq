...
<div style="width:510px;margin: 0 auto;">
    ...
    <form method="post" action="<c:url value="/foodAdd"/>" enctype="multipart/form-data" >
        <div style="margin:0 auto;width: 430px;height: 800px;">
            ...
            <div class="form-group" style="margin-top:20px;">
                <label>菜　　　名：</label>
                <input type="text" class="form-control" name="f_name" placeholder="菜名" style="width: 200px;display: inline-block;" required>
            </div>
            <div class="form-group" style="margin-top:20px;">
                <label >价　　　格：</label>
